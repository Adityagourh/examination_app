...
<form action="student_verifiy.jsp" method="get">
 <table cellpadding="12" id="t1">
 <tr>
<th><img src="loginlogo.jpg" alt="Paris" style="margin-left:auto;margin-right:auto;"></th>
 ...
 <th colspan="2"><input type="submit"value="Login" class="t" id="button"></th>
  ...
  <tr><th style="color:rgba(51,159,252,1.0);">Don't have any account? Contect Admin</th>  
  </tr> 
 </table>
</form>
</div>
