<html>
    <head>
        <style>
            ...
            <script type="text/javascript">
                function demo()
                {
                    ...
                    x2 = document.getElementById('address').value;
        ...
        <body id="body">
            ...
            <form action="studentRegisVerification.jsp" name="form" method="post">
                <table id="table" cellpadding="15">
                    ...
                    <div id="div1">
                        ...
                        <td>Email<br><input type="email" placeholder="abc@gmail.com" name="email" class="text" id="email"><p style="color:red;"id="nam1"></p></td>
                        </tr>

                        <!-- Password and ConfirmPassowrd -->
                        <tr>
                        <div id="div2">
                            <td>Password<br><input type="password" placeholder="*******" name="password" class="text" id="password"><p style="color:red;"id="nam2"></p></td>
                            <td>Confirm Password<br><input type="text" name="confirmPassword" class="text" id="cPassword"><p style="color:red;"id="nam4"></p></td>
                        </div>
                        </tr>
                        ...
                        <tr>
                        <div id="div3">
                            <td>Phone Number<br><input type="text" placeholder="1234567890" name="phone" class="text" id="phone"><p style="color:red;"id="nam5"></p></td>
                            <td>Address <br><input type="password" placeholder="india" name="address" class="text" id="address"></td>
                        </div>
                        </tr>
            ...
            <footer>
                <p>&copy; 2023 mr_gourh all rights reserved.</p>
            </footer>
        </body>
